$(function(){
    ...
    function addEvt(){
        var item = app.ui.form.init({
            title:'添加用户',
            url:'/page/default/tpl/form.html?p=form'
            ,data:{optType:'new',items:[
                //{label:'用户名',dt:'text',qt:'like',name:"userName"},
                //{label:'用户名',dt:'text',qt:'like',name:"userName"},
                {label:'用户名',dt:'text',qt:'like',name:"userName"}, 
                {label:'操作时间',dt:'date',qt:'btw',name:"optTime",len:140,cfg:{type: 'datetime',format:'yyyy-MM-dd HH:mm:ss'}}
            ...
            ,btns:[
                {title:'提交',handle:yuiCheck1,name:'yui-table-add-1'},
                {title:'继续添加',handle:yuiCheck,name:'yui-table-add'},
                {title:'测试',handle:yuiAdvance,css:['layui-btn-danger'],name:'yui-table-add2'}
            ]
        });
    }
    function yuiCheck(){
