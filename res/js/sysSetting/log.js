$(function(){
    var page = app.ui.page.list.init({
        ...
        grid:{
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'optTime', title: '操作时间4', width:180, align:'center',templet:function(d){
            ...
            btns:[
                ...
                {title:'导出',handle:function(){
                    layui.table.exportFile(['名字','性别','年龄'], [
                        ['张三','男','20'],
                        ['李四','女','18'],
                        ['王五','女','19']
                    ], 'xls'); //data 为该实例中的任意数量的数据
                },css:['layui-btn-danger'],name:'yui-table-add5'}
            ]
        }
    });
    ...
    var commonObj={
        ...
        item: [
            ...
            {label:'电话',name: "phone",verify:'required|phone',qt: 'eq'},
            {label:'汉族',name: "han"/* ,verify:'required' */,qt: 'lt',dt: 'radio',isBlock:true,
                cfg:{values:'1|2|3',text:'是|否|保密',checked:3}
            },
            {label:'车型',name: "carType"/* ,verify:'required' */,qt: 'lt',dt: 'checkbox',isBlock:true,
                cfg:{
                    data:{'1':'轿车','2':'越野车','3':'SUV','4':'自行车','5':'蹦蹦车','6':'碰碰车'},
            ...
            {label:'操作',name:'opt',qt:'eq',dt: 'switch',cfg:{values:'1|2',text:'男|女',checked:1}},
            {label:'是否加密',name:'pas',qt:'eq',dt: 'switch',cfg:{values:'1|2',text:'是|否'}},
           
            {label:'部门',name:"deptId",qt:'eq',eventName:'tree',treeCfg:{
